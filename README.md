...
A C++20 headers-only library to compute the root of numerical functions, using
the Newton's method or the Zhang's (a modified Brent's) method 
(https://iem.com/wp-content/uploads/2018/03/IJEA-33.pdf).
